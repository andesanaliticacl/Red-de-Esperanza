...
-- El trigger ya existe desde la 56 y apunta a esta misma función, así que
-- con reemplazar el cuerpo basta. Se recrea igual por si se corrió la 56 a
-- medias en algún entorno.
